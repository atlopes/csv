...
* Date and Datetime source data defined by format patterns (that may be created automatically)
...
* In a project, include csv-processor.prg, csv.prg and its dependencies
...
* atlopes, found here, [Foxite](https://www.foxite.com), and [Tek-Tips](https://www.tek-tips.com).